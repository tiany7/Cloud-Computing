...
#define XLOG( args...) testLog(cout,std::filesystem::current_path().c_str(), __func__,__LINE__ , #args, ##args)
#define XLOG_ERR( args...) testLog(cerr,std::filesystem::current_path().c_str(), __func__,__LINE__ , #args, ##args)
#define XLOG_STD( args...) testLog(cout, std::filesystem::current_path().c_str(), __func__,__LINE__ , #args, ##args)
